...
module.exports=async(req,res)=>{
  ...
  if(!slug||!url||!anonKey){
    ...
    return res.end('<!doctype html><meta charset="utf-8"><title>Kronika 82</title><p>Artykuł będzie dostępny po podłączeniu Supabase.</p>');
  }
...
<title>${esc(article.title)} • Kronika 82</title>
...
<link rel="stylesheet" href="/styles.css?v=6"><link rel="stylesheet" href="/mobile.css?v=7"><link rel="stylesheet" href="/front-final.css?v=25"><link rel="stylesheet" href="/article-gallery.css?v=3">
